...
class ArtifactControllerTest {
    ...
    void testAddArtifactSuccess() throws Exception {
        ...
        given(artifactService.save(any(Artifact.class))).willReturn(savedArtifact);
    ...
    void testUpdateArtifactSuccess() throws Exception
    {
        ...
        given(artifactService.update(eq("1250808601744904192"),any(Artifact.class))).willReturn(updatedArtifact);
    ...
    void testUpdateArtifactErrorWithNonExistentId() throws Exception
    {
        ...
        given(artifactService.update(eq("1250808601744904192"),any(Artifact.class))).willThrow(new ArtifactNotFoundException("1250808601744904192"));
